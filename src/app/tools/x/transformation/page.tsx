...
- Output ONLY the 4-line post. Nothing else.`
  ...
  const extraContent = (
    <div className="prose">
      ...
      <h3 style={{ fontFamily: 'Syne, sans-serif', fontSize: 18, fontWeight: 700, marginBottom: 16 }}>Why This Matters for SEO</h3>
      <p style={{ color: 'var(--text-secondary)', lineHeight: 1.8, marginBottom: 20 }}>
        "Transformation" and "Before and After" content are some of the most searched terms for niche-specific advice. 
        By utilizing this tool, you create "Thin-Content-Proof" posts that Google's robots recognize as structured, valuable advice. 
        It allows you to dominate the "How-To" keywords in your niche while keeping your content brief and viral-ready.
      </p>
    </div>
  );
