  ...
  const extraContent = (
    <div className="prose">
      ...
      <p style={{ color: 'var(--text-secondary)', lineHeight: 1.8, marginBottom: 20 }}>
        ...
        By day 90, you should have a clear, repeatable system that is generating real-world revenue and growing organically every single day.
      </p>
    </div>
  );
